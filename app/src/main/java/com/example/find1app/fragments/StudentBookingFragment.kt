...
import com.example.find1app.databinding.FragmentStudentBookingBinding

class StudentBookingFragment : Fragment() {

    private var _binding: FragmentStudentBookingBinding? = null
